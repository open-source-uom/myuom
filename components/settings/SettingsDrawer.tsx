...
import { CloseIcon } from "@/public/static/assets/icons";
            ...
            >
              <Link href={"/faq"}>
                <SettingsOption
                  ...
                  onClick={onClose}
                  text={i18n.t("frequent_questions")}
                />
              </Link>
              ...
              >
                <SettingsOption
                  Icon={FaBook}
                  onClick={onClose}
                  text={i18n.t("app_manual")}
                />
              </a>
              <SettingsOption
                Icon={FaShareAlt}
                onClick={handleShare}
                text={i18n.t("share_app")}
              />
              <a
