const FirstYearInfo = [
  {
    ...
    content: [
      "Μεταβείτε στην σελίδα δήλωσης συγγραμμάτων Εύδοξος που θα βρείτε στο πρώτο σύνδεσμο.",
  ...
  },
  {
    ...
    content: [
      "Μπορείτε να ζητήσετε ακαδημαϊκή ταυτότητα από την 1η διεύθυνση που θα βρείτε στους σχετικούς συνδέσμους.",
      "Στην δεξιά στήλη, επάνω, έχει κουμπί Εγγραφή/Εισοδος. Πατήστε εκεί.",
      "Στην είσοδος, επιλέξτε προπτυχιακός φοιτητής και χρησιμοποιήστε το username του email του uom.edu.gr και τον κωδικό που μας δώσανε.",
      ...
      "Στη συνέχεια τσεκάρετε τα στοιχεία σας, μήνα εισαγωγής εισάγετε Οκτώβριο , εισάγετε και την φωτογραφία για την ακαδημαϊκή ταυτότητα.",
      "Δηλώνετε από που θέλετε να παραλάβετε την ταυτότητά σας.",
  ...
  },
  {
    ...
    content: [
      ...
      "Επιλέξτε στο Εκπαιδευόμενο την Πιστοποίηση μέσω του Ιδρυματικού Λογαριασμού URegister.",
      ...
      "Στα Μαθήματα (αριστερή στήλη), θα μετακινηθείτε στο Προπτυχιακά (Undergraduate) » Τμήμα Εφαρμοσμένης Πληροφορικής (Department of Applied Informatics).",
  ...
  },
  {
    ...
    content: [
      ...
      "Αρχικά τα θα βρείτε όλα στην σελίδα του πανεπιστημίου και θα τα βρείτε όλα στο πρώτο σύνδεσμο.",
  ...
  },
  {
    ...
    content: [
      "Θα βρείτε στο πρώτο σύνδεσμο μία ανακοίνωση του ακαδημαϊκού έτους 2020-2021.",
