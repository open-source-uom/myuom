const FirstYearInfo = [
  {
    ...
    content: [
      "Αίτηση εγγραφής επιτυχόντα/ούσας Θα την λάβετε από την Εφαρμογή Ηλεκτρονικής Εγγραφής στην Τριτοβάθμια Εκπαίδευση (ο παρακάτω σύνδεσμος).",
      "Εισάγετε τον 8ψηψιο κωδικό εξετάσεων υποψηφίου ως όνομα χρήστη και ως κωδικό ασφαλείας (password), τον ίδιο που χρησιμοποίησατε για την εισαγωγή σας στην ηλεκτρονική εφαρμογή του Μηχανογραφικού Δελτίου.",
  ...
  {
    tab: "2",
    title: "Είσοδος στην σελίδα uom register.",
    content: [
      "Εδώ χρησιμοποιείτε τα στοιχεία Κωδικός Υποψηφίου (θα το βρείτε στην κάρτα που δώσατε εξετάσεις αλλά και την αίτηση στο υπουργείο).",
      "Αρχικά Υποψηφίου (τα 4 κεφαλαία αρχικά των ονομαστικών σου στοιχείων με τη σειρά: Επώνυμο, Όνομα, Πατρώνυμο, Μητρώνυμο) και ΑΜΚΑ.",
  ...
  {
    tab: "1",
    title: "Είσοδος στην σελίδα uom register (συνέχεια 2).",
    content: [
      "Στη συνέχεια, ακολουθήστε με προσοχή τις οδηγίες για την εγγραφή σας. ",
      "Προηγουμένως, εξασφάλισε ότι έχετε διαθέσιμα σε ηλεκτρονική μορφή τα δικαιολογητικά που απαιτούνται (αν οι εγγραφές γίνουν online)!",
      "Να τσεκάρετε την ιστοσελίδα της σχολής σας. Τα δικαιολογητικά είναι συνήθως τα παρακάτω:",
      ...
      "ii. Αίτηση εγγραφής (από την Εφαρμογή Ηλεκτρονικής Εγγραφής στην Τριτοβάθμια Εκπαίδευση (ΒΉΜΑ 1) επιτυχόντα υπογεγραμμένη από τον υποψήφιο (πρέπει να την εκτυπώσετε και να την υπογράψετε στο κάτω μέρος, σε οποιοδήποτε σημείο θέλετε).",
      "iii. Φωτογραφία (αρχείο .jpg, με διαστάσεις τουλάχιστον 240 x 240 px).",
      "Όσοι δεν έχετε, μπορείτε να βγάλετε μια φωτογραφία με το κινητό σας ή βγάλτε μια selfie.",
      " Για να επεξεργαστείτε την φωτογραφία μπορείτε χρησιμοποιήσετε κάποιο πρόγραμμα επεξεργασίας εικόνας όπως photoshop,",
      "gimp ή και online στον δεύτερο σύνδεσμο",
      "iv. Υπεύθυνη Δήλωση ΜΗ εγγραφής σε άλλη Σχολή ή Τμήμα Τριτοβάθμιας Εκπαίδευσης."
    ],
    links: [
      "https://www.uom.gr/register",
      "https://www.photopea.com/", 
    ],
  },
  {
    tab: "2",
    title: "Είσοδος στην σελίδα uom register (συνέχεια 3).",
    content: [
      "Την δήλωση αυτή μπορείτε να την εκτυπώσετε από τον παρακάτω σύνδεσμο και να πάτε να την υπογράψετε σε κάποιο ΚΕΠ.",
      "Επάνω συμπληρώνετε το τμήμα σας",
      "Εναλλακτικά μπορείτε να το κάνετε και μέσα από το gov.gr αρκεί να έχετε λογαριασμό τραπέζης ή λογαριασμό στην εφορία.",
      "Με αυτό τον τρόπο δεν χρειάζεται να πάτε στο ΚΕΠ.",
      ...
      "Στην φόρμα εγγραφής (εάν οι εγγραφές θα είναι online αλλά μπορεί να γίνει και δια ζώσης) θα ζητηθούν",
  ...
  },
  {
    ...
    content: [
      ...
      "Για την αλλαγή Password στην υπηρεσία UREGISTER μπορείτε να εισέλθετε στην δεύτερη διεύθυνση.",
      "Θυμήθείτε, εφόσον άλλαξετε το συνθηματικό θα πρέπει με το νέο συνθηματικό να εισέρχεστε σε όλες τις διαδικτυακές υπηρεσίες,",
      " (εκτός από το GMAIL, που είναι ξεχωριστή υπηρεσία και τη διαχειρίζεσαι από το περιβάλλον του GMAIL)."
    ],
    links: ["https://uregister.uom.gr/",
            "https://mypassword.uom.gr/"
          ],
  },
  {
    tab: "2",
    ...
    content: [
      ...
      "Προσοχή, αν έχετε κάνει σύνδεση στο Gmail με το προσωπικό σας λογαριασμό,",
      "είτε κάνετε έξοδο για να μπείτε με τα στοιχεία που σας έδωσαν ή μπορείτε να ανοίξετε καρτέλλα ιδιωτικής περιήγησης για να το ενεργοποιήσετε εκεί.",
    ],
