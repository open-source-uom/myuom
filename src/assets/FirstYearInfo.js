const FirstYearInfo = [
  {
    ...
    content: [
      "Θα την λάβετε από την Εφαρμογή Ηλεκτρονικής Εγγραφής στην Τριτοβάθμια Εκπαίδευση μέσω του παρακάτω συνδέσμου.",
  ...
  {
    tab: "2",
    title: "Είσοδος στην σελίδα UoM Register (1)",
    content: [
      "Στο παρακάτω σύνδεσμο χρησιμοποιείτε τα στοιχεία Κωδικός Υποψηφίου (θα το βρείτε στην κάρτα που δώσατε εξετάσεις αλλά και την αίτηση στο υπουργείο).",
  ...
  {
    tab: "1",
    title: "Είσοδος στην σελίδα UoM Register (2)",
    content: [
      "Στη συνέχεια, ακολουθήστε με προσοχή τις οδηγίες για την εγγραφή σας. ",
      "Προηγουμένως, εξασφαλίστε ότι έχετε διαθέσιμα σε ηλεκτρονική μορφή τα δικαιολογητικά που απαιτούνται.",
  ...
  {
    tab: "2",
    title: "Είσοδος στην σελίδα UoM Register (3)",
    content: [
      "Την δήλωση αυτή μπορείτε να την εκτυπώσετε από τον παρακάτω σύνδεσμο και να την υπογράψετε σε κάποιο ΚΕΠ.",
      ...
      "ΠΡΟΣΟΧΗ: α είστε σίγουροι για τα αρχεία που θα στείλετε πριν τα στείλετε. Δεν μπορείτε να τα διορθώσετε μετά.",
      ...
      "Στους αριθμούς, δέχεται μόνο αριθμούς. Μην βάζετε την / απλά μόνο τους αριθμούς.",
