...
import data from "@/public/static/assets/data/DailyMenu";
import { RESTAURANT_HOURS } from "@/public/static/assets/data/RestaurantSchedule";
...
function getNextMeal(curr_date) {
  ...
  const [endingDinnerHour, endingDinnerMinutes] = [
    isWeekDay
      ...
      : RESTAURANT_HOURS.for_dinner.on_weekend.end.hours,
    isWeekDay
      ? RESTAURANT_HOURS.for_dinner.on_weekdays.end.minutes
      : RESTAURANT_HOURS.for_dinner.on_weekend.end.minutes,
  ];
