...
npm start
``` 
Runs the application on [localhost:3000](http://localhost:3000),When the project migrates to Vite.js, the command to start the application will change to: npm run dev
